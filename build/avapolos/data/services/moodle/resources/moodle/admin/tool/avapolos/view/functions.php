...
<?php
  ...
  class Connect_SSH{
    ...
    public function __construct($ip, $port, $login, $password){
      ...
      $this->sh_file     = 'scripts/sync/sync.sh'; //Script de sincronização! Este arquivo nunca muda a menos que seja mudado também na raiz do sistema
      $this->output_file = 'scripts/sync/sync.log'; //Arquivo de log
    }
