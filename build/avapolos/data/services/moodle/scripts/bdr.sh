...
";
execSqlOnMoodleDB db_moodle_ies "SELECT bdr.bdr_node_join_wait_for_ready()";
execSqlOnMoodleDB db_moodle_ies "SELECT bdr.bdr_nodes.node_status FROM bdr.bdr_nodes;";
...
execSqlOnMoodleDB db_moodle_ies "SELECT bdr.bdr_nodes.node_status FROM bdr.bdr_nodes;";
sleep 3
execSqlOnMoodleDB db_moodle_polo "SELECT bdr.bdr_node_join_wait_for_ready()";
execSqlOnMoodleDB db_moodle_ies "SELECT bdr.bdr_nodes.node_status FROM bdr.bdr_nodes;";
...
execSqlOnMoodleDB db_moodle_polo "SELECT bdr.wait_slot_confirm_lsn(NULL, NULL)";
execSqlOnMoodleDB db_moodle_ies "SELECT bdr.wait_slot_confirm_lsn(NULL, NULL)";
